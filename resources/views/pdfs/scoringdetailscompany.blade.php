...
<html lang="en">
  ...
  <body>
    <div class="p-1">
      ...
      <h5 class="mt-4" style="font-weight: bold">Scoring de Riesgos / Persona Jurídica</h5>
      ...
      <table class="table">
        ...
        <tbody>
          ...
          <tr>
            <td>Tipo de persona jurídica</td>
            <td>{{ $result['data']['type'] }}</td>
            <td>{{ $result['data']['type_risk'] }}</td>
            <td>{{ $result['data']['type_imp'] }}</td>
          </tr>
          <tr>
            <td>Tamaño de empresa</td>
            <td>{{ $result['data']['size'] }}</td>
            <td>{{ $result['data']['size_risk'] }}</td>
            <td>{{ $result['data']['size_imp'] }}</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>{{ $result['data']['composition'] }}</td>
            <td>{{ $result['data']['composition_risk'] }}</td>
            <td>{{ $result['data']['composition_imp'] }}</td>
          </tr>
          <tr>
            <td>PEP</td>
