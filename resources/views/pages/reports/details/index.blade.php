...
@section('body')
  <div class="text-base my-4 breadcrumbs">
    <ul>
      ...
      <span id="reportId" class="hidden">{{ $reportId }}</span>
    </ul>
  </div>
      ...
      <form id="reportForm1" class="report--form">
        <div class="report--row--3">
          <div class="report--item">
            ...
            <select class="report--item--input" name="type" disabled>
          ...
          <div class="report--item">
            ...
            <select class="report--item--input" name="urgency" disabled>
              <option value="">Seleccione...</option>
            </select>
          </div>
          ...
          <div class="report--item">
            ...
            <select class="report--item--input" name="signaltype" disabled>
              <option value="">Seleccione...</option>
            </select>
          </div>
        </div>
        ...
        <div class="report--row--3">
          <div class="report--item">
            ...
            <div class="grid w-full">
              <input class="report--item--input" name="office" type="text" style="width: 100%" disabled />
            </div>
          </div>
          ...
          <div class="report--item">
            ...
            <div class="grid w-full">
              <input class="report--item--input" name="address" type="text" style="width: 100%" disabled />
            </div>
          </div>

          <div class="report--item">
            <div class="report--item--span"><span>Seleccione las señales de alerta:</span></div>
            <select class="report--item--input" name="signal" disabled>
              <option value="">Seleccione...</option>
            </select>
          </div>
        </div>
        ...
        <div class="report--row--3">
          <div class="report--row">
            <div class="report--item">
              ...
              <select class="report--item--input" name="department" disabled>
                <option value="">Seleccione...</option>
              </select>
            </div>
            ...
            <div class="report--item">
              ...
              <select class="report--item--input" name="province" disabled>
                <option value="">Seleccione...</option>
              </select>
            </div>
          </div>
          ...
          <div class="report--item">
            ...
            <select class="report--item--input" name="district" disabled>
              <option value="">Seleccione...</option>
            </select>
          </div>
          ...
          <div class="report--item">
            ...
            <select class="report--item--input" name="crime" disabled>
              <option value="">Seleccione...</option>
            </select>
          </div>
        </div>
        ...
        <div class="report--row">
          <div class="w7p">
            ...
            <select class="report--item--input" name="activity" disabled>
              <option value="">Seleccione...</option>
            </select>
          </div>
          ...
          <div class="w3p">
            ...
            <select class="report--item--input" name="crimetype" disabled>
              <option value="">Seleccione...</option>
            </select>
          </div>
        </div>
      ...
      <form id="reportForm2" class="report--form my-4">
        <div class="grid">
          <div class="flex justify-between">
            ...
            <label id="btnNewPeople" for="modal-report-people" class="modal-button btn btn-sm border-none bg-conoce-green p-0 w-44">
              + Nueva Persona
            </label>
          </div>
      ...
      <form id="reportForm3" class="report--form">
        <div class="report--row">
          <div class="w7p">
            ...
            <textarea class="report--item--input" name="details" type="text" rows="4" disabled></textarea>
          </div>

          <div class="w3p">
            <div class="report--item--span"><span>Producto:</span></div>
            <textarea class="report--item--input" name="product" type="text" rows="4" disabled></textarea>
          </div>
        </div>
        ...
        <div class="report--row--3">
          <div class="report--row">
            <div class="report--item">
              ...
              <div class="grid w-full">
                <input class="report--item--input" name="amount" type="text" style="width: 100%" disabled />
              </div>
            </div>

            <div class="report--item">
              <div class="report--item--span"><span>Moneda:</span></div>
              <select class="report--item--input" name="currency" disabled>
                <option value="">Seleccione...</option>
              </select>
            </div>
          </div>
          ...
          <div class="report--item">
            ...
            <input class="report--item--input" name="startedAt" type="date" disabled />
          </div>

          <div class="report--item">
            <div class="report--item--span"><span>Fecha hasta:</span></div>
            <input class="report--item--input" name="finishedAt" type="date" disabled />
          </div>
        </div>
        ...
        <div class="report--row">
          <div class="w7p">
            ...
            <textarea class="report--item--input" name="extra" type="text" rows="4" disabled></textarea>
          </div>
  ...
  <div class="modal">
    <div id="report--modal--people" class="modal-box relative p-0 w-11/12 max-w-5xl">
      ...
      <form id="reportModal" class="bg-white p-4 report--modal--content">
        <div class="report--row--3">  
          <div class="report--item">
            <div class="report--item--span"><span>P. Natural / P. Jurídica:</span></div>
            <select class="report--item--input" name="henry__" disabled>
              <option value="">Seleccione...</option>
          ...
          <div class="report--item">
            ...
            <select class="report--item--input" name="peopletype__" disabled>
              <option value="">Seleccione...</option>
            </select>
          </div>
          ...
          <div class="report--item">
            ...
            <select class="report--item--input" name="condition__" disabled>
              <option value="">Seleccione...</option>
            </select>
          </div>
        </div>
        ...
        <div class="report--row--3">
          <div class="report--item">
            ...
            <div class="grid w-full">
              <input class="report--item--input" name="lastname1__" type="text" style="width: 100%" disabled />
            </div>
          </div>
          ...
          <div class="report--item">
            ...
            <div class="grid w-full">
              <input class="report--item--input" name="lastname2__" type="text" style="width: 100%" disabled />
            </div>
          </div>
          ...
          <div class="report--item">
            ...
            <div class="grid w-full">
              <input class="report--item--input" name="name__" type="text" style="width: 100%" disabled />
            </div>
          </div>
        </div>
        ...
        <div class="report--row--3">
          <div class="report--item">
            ...
            <input class="report--item--input" name="birthday__" type="date" disabled />
          </div>

          <div class="report--item">
            <div class="report--item--span"><span>Nacionalidad:</span></div>
            <select class="report--item--input" name="nationality__" disabled>
              <option value="">Seleccione...</option>
            </select>
          </div>
          ...
          <div class="report--item">
            ...
            <select class="report--item--input" name="pep__" disabled>
              <option value="">Seleccione...</option>
        ...
        <div class="report--row--3">
          <div class="report--item">
            ...
            <select class="report--item--input" name="documenttype__" disabled>
              <option value="">Seleccione...</option>
            </select>
          </div>
          ...
          <div class="report--item">
            ...
            <div class="grid w-full">
              <input class="report--item--input" name="documentnumber__" type="text" style="width: 100%" disabled />
            </div>
          </div>

          <div class="report--item">
            <div class="report--item--span"><span>Profesión / Ocupación:</span></div>
            <select class="report--item--input" name="ocupation__" disabled>
              <option value="">Seleccione...</option>
            </select>
          </div>
        </div>
        ...
        <div class="report--row">
          <div class="w3p">
            ...
            <div class="grid w-full">
              <input class="report--item--input" name="cellphone__" type="text" style="width: 100%" disabled />
            </div>
          </div>
          ...
          <div class="w7p">
            ...
            <div class="grid w-full">
              <input class="report--item--input" name="email__" type="text" style="width: 100%" disabled />
            </div>
          </div>
        </div>
        ...
        <div class="report--item">
          ...
          <div class="grid w-full">
            <input class="report--item--input" name="address__" type="text" style="width: 100%" disabled />
          </div>
        </div>

        <div class="report--item">
          <div class="report--item--span"><span>País:</span></div>
          <select class="report--item--input" name="country__" disabled>
            <option value="">Seleccione...</option>
          </select>
        </div>
        ...
        <div class="report--row--3">
          <div class="report--item">
            <div class="report--item--span"><span>Departamento:</span></div>
            <select class="report--item--input" name="department__" disabled>
              <option value="">Seleccione...</option>
            </select>
          </div>
          ...
          <div class="report--item">
            <div class="report--item--span"><span>Provincia:</span></div>
            <select class="report--item--input" name="province__" disabled>
              <option value="">Seleccione...</option>
            </select>
          </div>
          ...
          <div class="report--item">
            <div class="report--item--span"><span>Distrito:</span></div>
            <select class="report--item--input" name="district__" disabled>
              <option value="">Seleccione...</option>
            </select>
          </div>
        </div>
...
@push('js')
<script>
    var report = {!! json_encode($report->toArray()) !!};
    window.report = report;
  </script>
  <script src="{{ asset('js/reports-details.js') }}" type="text/javascript"></script>
@endpush