      ...
      <form>
        <div class="scoring--card--col">
          ...
          <div class="scoring--details--group">
            <div class="scoring--details--item">
              ...
              <select class="scoring--details--item--input" name="ocupation" disabled></select>
            </div>

            <div class="scoring--details--item">
              <div class="scoring--details--item--span"><span>Persona Natural con Negocio:</span></div>
              <select class="scoring--details--item--input" name="hasCompany" disabled>
        ...
        <div class="scoring--card--col">
          ...
          <div class="scoring--details--item">
            ...
            <select class="scoring--details--item--input" name="aux" disabled></select>
            <select class="scoring--details--item--input hidden" name="scstatus" disabled></select>
            <select class="scoring--details--item--input hidden" name="ciu" disabled></select>
          </div>

          <div class="scoring--details--group">
            <div class="scoring--details--item">
              <div class="scoring--details--item--span"><span>Cliente Sensible:</span></div>
              <select class="scoring--details--item--input" name="sensible" disabled></select>
            </div>
...
@push('js')
  ...
  <script src="{{ asset('js/scoring-details-natural.js') }}" type="text/javascript"></script>
@endpush
