...
@section('body')
  ...
  <div class="card bg-base-100 shadow-md rounded-md p-4">
    <div class="scoring--header--actions">
      <span class="text-xl font-bold">Scoring de Riesgo / Persona Natural</span>
      ...
      <form>
        <div class="scoring--card--col">
          <div class="scoring--details--item">
            <div class="scoring--details--item--span"><span>Nombre Completo / Razón Social:</span></div>
            <input class="scoring--details--item--input" name="fullname" type="text" />
          </div>

          <div class="scoring--details--group">
            <div class="scoring--details--item">
              <div class="scoring--details--item--span"><span>Ocupación / Profesión:</span></div>
              <select class="scoring--details--item--input" name="ocupation"></select>
            </div>

            <div class="scoring--details--item">
              <div class="scoring--details--item--span"><span>Persona Natural con Negocio:</span></div>
              <select class="scoring--details--item--input" name="hasCompany" >
        ...
        <div class="scoring--card--col">
          ...
          <div class="scoring--details--item">
            <div class="scoring--details--item--span"><span>CIIU ó Estado:</span></div>
            <select class="scoring--details--item--input" name="aux"></select>
            <select class="scoring--details--item--input hidden" name="scstatus"></select>
            <select class="scoring--details--item--input hidden" name="ciu"></select>
          </div>

          <div class="scoring--details--group">
            <div class="scoring--details--item">
              <div class="scoring--details--item--span"><span>Cliente Sensible:</span></div>
              <select class="scoring--details--item--input" name="sensible"></select>
            </div>
  ...
  <div class="modal">
    <div id="neglst--modal--massive" class="modal-box modal-alert relative p-0">
      ...
      <form class="flex justify-center" action="/scoring/massive-natural" method="POST" enctype="multipart/form-data">
        @csrf
...
@push('js')
  <script src="{{ asset('js/scoring-generate-natural.js') }}" type="text/javascript"></script>
@endpush
