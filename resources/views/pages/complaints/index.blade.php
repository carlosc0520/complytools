    ...
    <div class="row p-2">
      <div class="col-span-2">
        <div class="flex justify-end items-center gap-5">
          <button id="modalBtnCreateComplaint" class="btn btn-sm bg-conoce-green">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus" viewBox="0 0 16 16">
              <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z" />
            </svg>
            Denuncia
          </button>
          <!-- <button id="modalBtnCreateReason" class="btn btn-sm bg-conoce-green">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus" viewBox="0 0 16 16">
              <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z" />
            </svg>
             Causa de Denuncia
          </button>
          <button id="modalBtnCreateRelation" class="btn btn-sm bg-conoce-green">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus" viewBox="0 0 16 16">
              <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z" />
            </svg>
             Relación Empresa
...
<div class="modal">
  <div id="complaint--modal--details" class="modal-box modal-alert relative p-0">
    ...
    <form  id="formDetailsDenuncia" class="bg-white p-4 complaint--modal--content">
      ...
      <div class="grid">
        <span class="font-bold text-conoce-green text-xl" style="margin-bottom: 10px">Documentación</span>
        <div class="overflow-x-auto">
          <table id="table-conoce-denuncia" class="table-conoce">
            <thead>
              <tr>
                <th title="NOMBRE">NOMBRE</th>
                <th title="FECHA AGREGADO">F. AGREGADO</th>
                <th title=""></th>
              </tr>
            </thead>
            <tbody id="documentacion_files">
            </tbody>
          </table>
        </div>
      </div>
    ...
    <input type="number" id="complaintIdDenuncia" class="hidden">
    <div class="modal-action justify-between py-2 px-4 bg-modal complaint--buttons">
      <div>
        <span style="color: white">Fecha de Cierre:</span>
        <input id="expirationDate" name="expirationDate" type="date" class="mx-2 px-2 rounded">
...
<script>
  ...
  const windowInit = {
    init: () => {},
    globales: () => {
      $("#modalBtnCreateComplaint").on("click", function() {
        $.get("/api/v1/complaint/redirect/" + _userId)
          .done(function(data) {
            if (data.sitio != null) {
              window.open(data.sitio, '_blank');
            }
          })
          .fail(function(error) {
            console.log(error);
